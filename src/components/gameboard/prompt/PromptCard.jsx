...
export default function PromptCard({
  ...
  return (
    <div className="prompt-card">
      <h2 className="prompt-title">Category {category}</h2>
      ...
      <div className="prompt-instructions">
        {hasSubmittedResponse ? (
          <>
            <strong>{responderName}</strong> has answered.
            <strong> {reviewerName}</strong> should review the response and open rating when ready.
          </>
        ) : isResponder ? (
          <>
